    ...
    <section class="header-produto" :style="style">
      <div class="middle-center">
        ...
        <div class="display-title">
          <div class="item">
            <span class="title-sm">Soluções de</span>
          </div>
          <div class="item">
            <span class="title-lg">{{produto}}</span>
          </div>
          <div class="item">
            <span class="title-sm">para o Desenvolvedor.</span>
          </div>
        </div>
        <div class="botoes m-t-40">
            <a class="btn btn-white btn-rounded btn-md btn-arrow text-blue" :style="styleColor" data-animation="animated fadeInLeft" data-toggle="collapse" href="#" v-scroll-to="scroll"> <span>CONHEÇA <i class="ti-arrow-down"></i></span> </a>
            <a class="btn btn-white-inverse btn-rounded btn-md btn-arrow m-l-20" :style="styleBg" data-animation="animated fadeInLeft" data-toggle="collapse" href="#" v-scroll-to="'#formulario'"> <span>FALE COM A GENTE <i class="ti-arrow-down"></i></span> </a>
        </div>
      </div>
    </section>
  </div>
...
.display-title .title-sm {
  font-family: "GothamRnd-Book", sans-serif;
  font-size: 25px;
  line-height: 40px;
}
.display-title .title-lg {
...
@media (max-width: 767px) {
  ...
  .header-produto .display-title .title-sm {
    font-family: "GothamRnd-Book", sans-serif;
    font-size: 20px;
    line-height: 40px;
  }
  .header-produto .display-title .title-lg {
    font-family: "GothamRnd-Bold", sans-serif;
    font-size: 44px;
    line-height: 60px;
  }
  .header-produto .botoes a {
    margin-bottom: 20px;
  }
  .header-produto .m-b-40 {
